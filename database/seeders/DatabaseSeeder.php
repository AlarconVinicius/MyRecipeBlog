...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \App\Models\Difficulty::factory(1)->create(['nome' => 'Não Categorizado', 'slug' => 'nao-categorizado']);
        \App\Models\Difficulty::factory(1)->create(['nome' => 'Fácil', 'slug' => 'facil']);
        \App\Models\Difficulty::factory(1)->create(['nome' => 'Médio', 'slug' => 'medio']);
        \App\Models\Difficulty::factory(1)->create(['nome' => 'Difícil', 'slug' => 'dificil']);
